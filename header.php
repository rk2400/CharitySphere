...
<head>
    ...
    <link rel="mask-icon" href="images/logo.svg" color="#563d7c">
    <link rel="icon" href="aimages/logo.vg">
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-white big-nav" style="background-color: #ffcc00;" >
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php#themes">Our Themes</a>
                    </li>
                    <li class="nav-item">
